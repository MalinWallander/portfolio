...
function Projects(){
	return (
		...
		<div className='projectsCardContainer'>
			...
			<ProjectsCard title={'Game arcade'} screenshot={gameImg} description={'A project where we created retro styled geography related games using JavaScript, HTML and CSS. Calling real time (like temperature) data with APIs. I created the snake-game, guess the weather-game and bucket list.'} logoCSS={<DiCss3/>} logoJS={<DiJavascript/>} logoHTML={<DiHtml5/>} projectGit={'https://github.com/MalinWallander/Game-group-2'} projectURL={'https://shiny-maamoul-d09a01.netlify.app/'}/>

			<ProjectsCard title={'Client project'} screenshot={innerImg} description={'A project where we worked with UX-design students who made the design and we implemented in React. React router was used to create navigation and libraries for image-carousels.'} logoReact={<DiReact/>} logoRouter={<SiReactrouter/>} logoCSS={<DiCss3/>} projectGit={'https://github.com/MalinWallander/Game-group-2'} projectURL={'https://shiny-maamoul-d09a01.netlify.app/'}/>
			
			<ProjectsCard title={'Mulan 90s website'} screenshot={mulanImg} description={'My first ever coding project! It is all done in HTML and CSS. While not being the most sleek or complex, it shows where I began. And with a theme of 90s website, it was the perfect excuse to make it as ugly as possible!'} logoHTML={<DiHtml5/>} logoCSS={<DiCss3/>} projectGit={'https://github.com/MalinWallander/Mulan-website'} projectURL={'https://mellow-ganache-a272bd.netlify.app/'}/>
		</div>
		</div>
		</>
	)
